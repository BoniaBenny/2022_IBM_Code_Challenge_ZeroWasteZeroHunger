    ...
    <header>
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background-image: url('images/donatefood.jpg')">
...
?>
    ...
    <div class="container">
        ...
        <div class="gallery col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <h1 class="gallery-title">Food Availability</h1>
        </div>
    ...
    <section class="categories">
        <div class="container">
            ...
            <a href="abcrestruant.php">
            <div class="box-3 float-container">
                <img src="images/img2.jpg" alt="Pizza" class="img-responsive img-curve">

                <h3 class="float-text text-black">ABC restaurant</h3>
            </div>
            </a>
            <br></br>
            <a href="#">
            <div class="box-3 float-container">
                <img src="images/img3.jpg" alt="Burger" class="img-responsive img-curve">

                <h3 class="float-text text-black">Kripa Bhavan</h3>
            </div>
            </a>
            <br></br>
            <!--
            <a href="#">
            <div class="box-3 float-container">
                <img src="images/img2.jpg" alt="Momo" class="img-responsive img-curve">
            ...
            <a href="#">
            <div class="box-3 float-container">
                <img src="images/img3.jpg" alt="Pizza" class="img-responsive img-curve">
            ...
            <a href="#">
            <div class="box-3 float-container">
                <img src="images/img2.jpg" alt="Burger" class="img-responsive img-curve">
            ...
            <a href="#">
            <div class="box-3 float-container">
                <img src="images/img3.jpg" alt="Momo" class="img-responsive img-curve">
